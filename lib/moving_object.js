 ...
 * MovingObject
 *
 * Класс отвечает за передвижение предметов
 *
 * @author Basenok
 * @version 1.0.2
...
/**
   * Содержится ли в массиве массив
   *
   * @param array mainArr стены
   * @param array subArr стены
   */
...
/**
   * Передвижение предмета при условии, что можно это сделать
   *
   * @param array walls стены
   */
  move(walls) {
