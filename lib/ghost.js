...
class Ghost extends MovingObject {
  ...
  /**
   * Попытка движения по Х
   *
   * @param string xDif разность
   * @param array walls пстены
   * @param string retry пытаться еще
   */
